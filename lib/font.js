...
var Font = function(size){
	...
	this.radio_x = 0.6
	this.radio_y = 1
	this.font_x = this.fontsize*this.radio_x
	this.font_y = this.fontsize*this.radio_y
	this.offset = {
		x : Number.parseInt(size/2-this.font_x/2),
		y : Number.parseInt(size/2+this.font_y/2-size*0.14)
	}
...
function CnFont(size){
	...
	this.offset = {
		...
		y: Number.parseInt(size/2+this.fontsize/2-size*0.05)
	}
}
